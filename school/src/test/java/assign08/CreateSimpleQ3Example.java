...
/**
 * Creates a SIMPLE and CLEAR example for Question 3. Both goals must be
 * reachable. The concept: - BFS finds CLOSER goal but searches MANY nodes
 * (explores all branches) - DFS finds FARTHER goal but searches FEW nodes (goes
 * straight to it)
 *
