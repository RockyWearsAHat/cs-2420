...
/**
 * Creates a CLEARER example for Question 3. The goal: Show DFS finding a
 * FARTHER goal with FEWER nodes than BFS.
 *
 * Key insight: - BFS explores in all directions evenly, so it gets "trapped"
 * exploring many branches - DFS goes deep in one direction, so if the farther
 * goal is in that direction, it finds it quickly
 *
