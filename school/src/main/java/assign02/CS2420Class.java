...
public class CS2420Class {
    ...
    private final ArrayList<CS2420Student> studentList;
    ...
    public ArrayList<CS2420Student> lookup(EmailAddress contactInfo) {
        ...
        ArrayList<CS2420Student> results = new ArrayList<>();
        for (CS2420Student student : studentList) {
    ...
    public void addScore(int uNID, double score, String category) {
        // FILL IN
        CS2420Student student = lookup(uNID);
        if (student != null) {
    ...
    /**
     * Adds the students specified by the input file to the collection of
     * students in CS 2420.
     *
     * Assumes a very strict file format: -- first line: FirstName LastName
     * (u0123456) userName@domainName -- second line: assignment scores,
     * separated by blank spaces -- third line: exam scores, separated by blank
     * spaces -- fourth line: lab scores, separated by blank spaces -- fifth
     * line: quiz scores, separated by blank spaces -- sixth line: poll scores,
     * separated by blank spaces -- seventh line ... : repeat of lines 1-6 for
     * another student
     *
    ...
    public void addAll(String filename) {
        String[] categories = {"assignment", "exam", "lab", "quiz", "poll"};
        ...
        try {
            ...
            while (fileIn.hasNextLine()) {
                ...
                // second-sixth lines: assignment, exam, lab, quiz, and poll scores
                for (int i = 0; i < 5; i++) {
     ...
     * @param lineNumber - line number in file, used for error reporting (see
     * above)
     * @return the CS2420Student constructed from the information
     * @throws ParseException if file containing line is not properly formatted
     * (see above)
     */
     ...
     *
     * @param line - string to be parsed
     * @param category - "assignment", "exam", "lab", "quiz", or "poll"
