...
/**
 * BufferedWriter version - writes chars directly to a writer.
 */
public class RandomPhraseGeneratorWriter {
    ...
    public static void main(String[] args) {
        ...
        // Use BufferedWriter with large buffer
        try (Writer out = new BufferedWriter(new OutputStreamWriter(System.out), 1048576)) {
