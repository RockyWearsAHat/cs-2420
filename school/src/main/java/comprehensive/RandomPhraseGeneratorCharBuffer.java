...
/**
 * Char buffer with periodic flush version.
 */
public class RandomPhraseGeneratorCharBuffer {
    ...
    private static String[] terminalStrings;
    ...
    public static void main(String[] args) {
        ...
        final int[][][] g = grammar;
        final String[] t = terminalStrings;
        ...
        for (int p = 0; p < numPhrases; p++) {
            ...
            while (top > 0) {
                ...
                if (symbol < 0) {
                    ...
                    int len = term.length();
                    // Flush if needed
                    if (bufPos + len + 1 > 524288) {
                        out.print(new String(buffer, 0, bufPos));
                        bufPos = 0;
                    }
    ...
    private static void finalizeGrammar() {
        ...
        terminalStrings = terminals.toArray(new String[0]);
    }
